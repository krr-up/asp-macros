...
\newcommand{\intervc}[2]{\ensuremath{[#1..#2]}}
\newcommand{\intervo}[2]{\ensuremath{[#1..#2)}}
\newcommand{\ointerv}[2]{\ensuremath{(#1..#2]}}
\newcommand{\intervo}[2]{\ensuremath{(#1..#2)}}
\newcommand{\rangec}[3]{\ensuremath{#1 \in \intervc{#2}{#3}}}
\newcommand{\rangeo}[3]{\ensuremath{#1 \in \intervo{#2}{#3}}}
\newcommand{\orange}[3]{\ensuremath{#1 \in \ointerv{#2}{#3}}}
\newcommand{\rangeo}[3]{\ensuremath{#1 \in \intervo{#2}{#3}}}
