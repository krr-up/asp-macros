...
\lstdefinelanguage{clingcon}[]{clingo}{morekeywords={&dom,&sum,&nsum,&diff,&disjoint,&distinct,&minimize,&maximize,&show}}
\lstdefinelanguage{fclingo}[]{clingo}{morekeywords={&sum,&sus,&in,&df,&min,&max,&show}}
\lstdefinelanguage{clingodl}[]{clingo}{morekeywords={&diff}}
